...
const Productdb = require("./dbModel");
...
const connection_url =
  "mongodb+srv://admin:CgWO2cgMU34vimVI@cluster0.qqwge.mongodb.net/productapi?retryWrites=true&w=majority";
...
app.post("/addproducts", (req, res) => {
  ...
  const dbprod = req.body;
  Productdb.create(dbprod, (err, data) => {
    if (err) {
      res.status(500).send(err);
    } else {
